...
public class Placar {
  ...
  public void getScore(Carta[] cartas, int numCartas, int aposta) {
    ...
    // Se houver uma sequencia de cartas do 8 ate o As de mesmo naipe, recebe 200x o
    // valor da aposta
    if (flush == 1 && royal >= 1) {
    ...
    // Se houverem 5 cartas do mesmo naipe nao seguidas, recebe 10x o valor da
    // aposta
    ...
    // Se houverem 5 cartas diferentes (com naipes diferentes), recebe 5x o valor da
    // aposta
